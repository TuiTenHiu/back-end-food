...
<div class="heading">
   <h3>giỏ hàng</h3>
   <p><a href="index.php">Trang Chủ</a> <span> / Giỏ Hàng</span></p>
</div>
...
<section class="products">
   ...
   <div class="cart-total">
      <p>Tổng tất cả đơn hàng: <span><?= $grand_total; ?></span>đ</p>
   ...
   <div class="more-btn">
      <form action="" method="post">
         ...
         <?= ($grand_total > 1)?'':'disabled'; ?>" name="delete_all" 
         onclick="return confirm('xóa tất cả khỏi giỏ hàng?');">xóa tất cả</button>
      </form>
